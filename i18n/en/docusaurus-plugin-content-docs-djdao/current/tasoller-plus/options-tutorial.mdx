...
<div style={{marginBottom: '1.5rem', display: 'flex', gap: '1rem', flexWrap: 'wrap'}}>
  <a className="button button--primary" href="/download/tasoller-plus/TASOLLER-plus-option-V2.8.zip">Click to download firmware and TASOLLER Options V2.8</a>
</div>
...
<FaqAccordion>
<FaqItem question="What are the functions of FN1 and FN2?">
...
<FaqItem question="Calibration function (parameters remain unchanged, the judgment in the game is normal sometimes and abnormal sometimes)">
...
<FaqItem question="What to do if a key is stuck (the key is still pressed even though the hand is released)">
...
<FaqItem question="What is the relationship between threshold and sensitivity?">
...
<FaqItem question="Why is the threshold in the game test set to 20?">
...
<FaqItem question="What is the advanced threshold setting in Options?">
